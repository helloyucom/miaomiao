...
<style scoped>
.messageBox {width: 200px; height: 120px; border: 1px solid #ccc; border-radius: 4px; box-shadow: 4px 4px 4px 4px #ccc; position: absolute; left: 50%; top: 50%; margin: -60px 0 0 -100px; background-color: #FFF;}
